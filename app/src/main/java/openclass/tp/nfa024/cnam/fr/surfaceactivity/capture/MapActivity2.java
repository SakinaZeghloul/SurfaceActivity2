package openclass.tp.nfa024.cnam.fr.surfaceactivity.capture;
...
import openclass.tp.nfa024.cnam.fr.surfaceactivity.modèle.Scanner;
...
import static openclass.tp.nfa024.cnam.fr.surfaceactivity.constantes.Constantes.LONGITUDE_RAPHAEL;
import static openclass.tp.nfa024.cnam.fr.surfaceactivity.constantes.Constantes.POINT_RADIUS;
import static openclass.tp.nfa024.cnam.fr.surfaceactivity.constantes.Constantes.PROX_ALERT_EXPIRATION;
import static openclass.tp.nfa024.cnam.fr.surfaceactivity.constantes.Constantes.RAPHAEL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retourAccueil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent accueil = new Intent(view.getContext(), EnigmeRecycler.class);
